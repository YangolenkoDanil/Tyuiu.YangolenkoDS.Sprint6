...
namespace Tyuiu.YangolenkoDS.Sprint6.Task7.V25.Test
{
    [TestClass]
    public class DataServiceTest
    {
        ...
        public void TestMethod1()
        {
            ...
            int[,] array = new int[10, 10] { { -17, -17, 16, -19, 10, -15, -20, 4, 18, 19 },
            ...
            int[,] arrayWait = new int[10, 10] { { -17, -17, 16, -19, 10, -15, 2, 4, 18, 19 },
                                                { -13, -19, -4, 17, 13, -11, -16, -1, 6, 10 },
                                                { -19, -19, -6, 7, 3, 11, 8, -16, -9, -8 },
